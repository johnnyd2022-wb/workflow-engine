...
Generated artifacts land here — the running record of what the skills produce each cycle.
Overwrite or date-stamp as you prefer (e.g. `weekly-command-centre-2026-07-06.md`).

| File | Produced by | Cadence |
|---|---|---|
| `weekly-command-centre.md` | Business Operator | weekly |
| `weekly-schedule.md` | Calendar Planner | weekly |
