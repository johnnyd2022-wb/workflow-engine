...
wb_app_build() {
        ...
        #sed -i "s/,\s*ssl_context=('certificate.pem', 'private.key')//" '/home/johnny/wb_conn/app.py'
        ...
        #sed -i 's/johnny@whistlebird.co.nz/sales@whistlebird.co.nz/g' '/home/johnny/wb_conn/app.py'
